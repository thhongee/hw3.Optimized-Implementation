...
set IMAGE_DIR           ".."
set IN_FILE_NAME        "${IMAGE_DIR}/lena_gray_256_noise.bmp"
set OUT_FILE_NAME				"lena_gray_256_noise_out.bmp"
...
define_sim_config V_BASIC "dut RTL_V BASIC" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.3 The Verilog simulation for HLS config "DPA". 
define_sim_config V_DPA "dut RTL_V DPA" -argv "$IN_FILE_NAME $OUT_FILE_NAME"

define_sim_config V_PIPELINE "dut RTL_V PIPELINE" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
